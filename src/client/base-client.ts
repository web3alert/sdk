...
export type BaseClientStackParams = {
  telemetry: Telemetry;
  core: Core;
  name: string;
  container: Container;
...
export class BaseClientStack {
  public telemetry: Telemetry;
  public core: Core;
  public name: string;
  public container: Container;
  
  constructor(params: BaseClientStackParams) {
    const {
      telemetry,
      core,
      name,
...
export type BaseClientParams = BaseClientStackParams;

export class BaseClient extends BaseClientStack {
  private _bucket: Bucket<unknown> | undefined;
  
  public local: BaseClientLocal;
  ...
  protected _local(): BaseClientLocal {
    return new BaseClientLocal({
...
export type BaseClientLocalParams = BaseClientStackParams;

export class BaseClientLocal extends BaseClientStack {
  constructor(params: BaseClientLocalParams) {
    super(params);
  }
